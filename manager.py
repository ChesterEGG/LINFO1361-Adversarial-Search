...
if __name__ == "__main__":
    ...
    parser.add_argument("-p0", type=str, default=HEU2_ALPHABETA_AGENT_MO_DI, help="First player file (default: random_agent.py)")
    parser.add_argument("-p1", type=str, default=BASE_MINIMAX_AGENT_d3, help="Second player file (default: random_agent.py)")
